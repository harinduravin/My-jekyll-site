  ...
  module Linkpreview
    ...
    class LinkpreviewTag < Liquid::Tag
      ...
      def render(context)
        ...
        render_linkpreview(properties,context)
      end
      ...
      private
      def render_linkpreview(properties,context)
        ...
        if File.exist?(template_path)
          ...
          gen_default_template(properties.to_hash,context)
        end
      end
      ...
      private
      def gen_default_template(hash,context)
        title = hash['title']
        url = get_url_from(context)
